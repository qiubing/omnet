...
#ifndef _WAVESHORTMESSAGE2_M_H_
#define _WAVESHORTMESSAGE2_M_H_
...
/**
 * Class generated from <tt>modules/messages/WaveShortMessage2.msg</tt> by opp_msgc.
 * <pre>
 * packet WaveShortMessage2 {
 * 	
 * 	int wsmVersion = 0;
 * 	
 * 	int securityType = 0;
 ...
 * </pre>
 */
class WaveShortMessage2 : public ::cPacket
{
  protected:
    int wsmVersion_var;
  ...
  private:
    void copy(const WaveShortMessage2& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const WaveShortMessage2&);

  public:
    WaveShortMessage2(const char *name=NULL, int kind=0);
    WaveShortMessage2(const WaveShortMessage2& other);
    virtual ~WaveShortMessage2();
    WaveShortMessage2& operator=(const WaveShortMessage2& other);
    virtual WaveShortMessage2 *dup() const {return new WaveShortMessage2(*this);}
    ...
    virtual const Coord& getSenderPos() const {return const_cast<WaveShortMessage2*>(this)->getSenderPos();}
...
inline void doPacking(cCommBuffer *b, WaveShortMessage2& obj) {obj.parsimPack(b);}
inline void doUnpacking(cCommBuffer *b, WaveShortMessage2& obj) {obj.parsimUnpack(b);}


#endif // _WAVESHORTMESSAGE2_M_H_
